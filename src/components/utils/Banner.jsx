...
const Banner = () => {
  const [banner, setBanner] = useState("¡Paga tu compra sin interes!");
  useEffect(() => {
    const myArray = [
  ...
  return (
    <div className="flex relative container">
      <div className="block relative align-middle justify-center text-center  mx-auto mt-28 mb-5 p-1 w-[80%] h-max rounded-xl bg-purple-600 shadow-lg shadow-slate-400 xl:left-[10%] 2xl:left-[30%]">
