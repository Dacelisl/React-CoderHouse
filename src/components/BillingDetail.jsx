...
const BillingDetail = ({ order }) => {
  ...
  return (
    <div
      ...
      className={
        billing
          ? "absolute h-full w-full backdrop-blur-md top-[50%] left-[50%]  -translate-x-1/2 -translate-y-1/2 z-40 overflow-auto"
          : "hidden"
      }
    >
      <div className="">
        <div className="container absolute h-auto w-full  bg-slate-600 top-[50%] left-1/2 rounded-xl -translate-x-1/2 -translate-y-1/2 border-spacing-1 shadow-lg shadow-slate-400 py-6 px-7 mb-10 text-slate-50 overflow-scroll">
